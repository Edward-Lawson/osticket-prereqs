...
<p>
<h3 align="center">Now, create a Windows 10 Virtual Machine (VM), typically with 2–4 virtual CPUs. For the username and password, you can use any credentials, as we’ll be using this information to remotely connect from our main computer. When creating the Virtual Machine (VM), allow Azure to create a new Virtual Network (VNet):</h3>
<br />
</p>
<p>
